...
export default function APSClinicalModule() {
  ...
  return (
    <main className="main">
      <style>{`
        .domain-card { background: var(--surface); border: 1px solid var(--border); border-radius: 12px; padding: 1.5rem; margin-bottom: 1.25rem; }
        .domain-header { display: flex; align-items: flex-start; gap: 1rem; margin-bottom: 0.75rem; }
        .domain-num { width: 36px; height: 36px; min-width: 36px; border-radius: 50%; background: var(--accent); color: #fff; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1rem; }
        .domain-tagline { font-style: italic; color: var(--text-mid); font-size: 0.9rem; margin: 4px 0 0; }
        .domain-card h3 { margin: 0 0 2px; font-size: 1.1rem; }
        .domain-score { background: rgba(108,99,255,0.06); border-radius: 8px; padding: 0.5rem 0.9rem; margin: 10px 0; font-size: 0.9rem; }
