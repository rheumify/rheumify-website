...
<div className="content-section">
  <div className="room">
    ...
    <svg viewBox="0 0 666 290" width="100%" style={{display:'block',margin:'0.5rem auto 1rem'}} xmlns="http://www.w3.org/2000/svg">

      {/* PANEL 1: ANA — α left, β right, both blocked */}
      <rect x="4" y="4" width="206" height="282" rx="9" fill="white" stroke="#1D5F74" strokeWidth="2"/>
      <text x="107" y="29" textAnchor="middle" fontSize="14" fill="#1D5F74" fontWeight="bold" fontFamily="Georgia">ANAKINRA</text>
      <text x="107" y="45" textAnchor="middle" fontSize="10.5" fill="#7A7268" fontFamily="Georgia">Receptor Antagonist</text>
      <circle cx="68" cy="87" r="21" fill="#3A7EA0"/>
      <text x="68" y="95" textAnchor="middle" fontSize="21" fill="white" fontFamily="Georgia">&#945;</text>
      <circle cx="148" cy="87" r="21" fill="#C8964A"/>
      <text x="148" y="95" textAnchor="middle" fontSize="21" fill="white" fontFamily="Georgia">&#946;</text>
      <line x1="68" y1="110" x2="68" y2="134" stroke="#3A7EA0" strokeWidth="1.5" strokeDasharray="3,2"/>
      <polygon points="63,132 73,132 68,141" fill="#3A7EA0"/>
      <line x1="148" y1="110" x2="148" y2="134" stroke="#C8964A" strokeWidth="1.5" strokeDasharray="3,2"/>
      <polygon points="143,132 153,132 148,141" fill="#C8964A"/>
      <text x="68" y="156" textAnchor="middle" fontSize="22" fill="#DC2626" fontFamily="Georgia">&#10005;</text>
      <text x="148" y="156" textAnchor="middle" fontSize="22" fill="#DC2626" fontFamily="Georgia">&#10005;</text>
      <rect x="16" y="160" width="180" height="28" rx="5" fill="#1D5F74"/>
      <text x="107" y="179" textAnchor="middle" fontSize="11.5" fill="white" fontWeight="bold" fontFamily="Georgia">ANA blocks ALL at the door</text>
      <rect x="16" y="206" width="180" height="22" rx="3" fill="#4A4540"/>
      <rect x="70" y="200" width="74" height="28" rx="2" fill="#1D5F74"/>
      <text x="107" y="243" textAnchor="middle" fontSize="9.5" fill="#7A7268" fontFamily="Georgia">Wall = IL-1 Receptor (door)</text>
      <text x="107" y="262" textAnchor="middle" fontSize="11" fill="#1D5F74" fontStyle="italic" fontFamily="Georgia">&#945; + &#946;: both blocked &#10003;</text>

      {/* PANEL 2: CANA — α LEFT free/crawls in, β RIGHT caught */}
      <rect x="230" y="4" width="206" height="282" rx="9" fill="white" stroke="#7C3AED" strokeWidth="2"/>
      <text x="333" y="29" textAnchor="middle" fontSize="14" fill="#7C3AED" fontWeight="bold" fontFamily="Georgia">CANAKINUMAB</text>
      <text x="333" y="45" textAnchor="middle" fontSize="10.5" fill="#7A7268" fontFamily="Georgia">Anti-IL-1&#946; mAb &#8212; &#946; only</text>
      <circle cx="278" cy="85" r="21" fill="#3A7EA0"/>
      <text x="278" y="93" textAnchor="middle" fontSize="21" fill="white" fontFamily="Georgia">&#945;</text>
      <circle cx="396" cy="85" r="21" fill="#C8964A"/>
      <text x="396" y="93" textAnchor="middle" fontSize="21" fill="white" fontFamily="Georgia">&#946;</text>
      <circle cx="396" cy="85" r="33" fill="none" stroke="#7C3AED" strokeWidth="2" strokeDasharray="5,3"/>
      <line x1="396" y1="120" x2="396" y2="140" stroke="#C8964A" strokeWidth="1.5" strokeDasharray="3,2"/>
      <text x="396" y="160" textAnchor="middle" fontSize="22" fill="#DC2626" fontFamily="Georgia">&#10005;</text>
      <rect x="338" y="163" width="94" height="28" rx="5" fill="#7C3AED"/>
      <text x="385" y="182" textAnchor="middle" fontSize="12" fill="white" fontWeight="bold" fontFamily="Georgia">CANA</text>
      <path d="M278,108 L274,150 Q270,172 264,192" fill="none" stroke="#3A7EA0" strokeWidth="2" strokeDasharray="4,2"/>
      <ellipse cx="262" cy="198" rx="16" ry="12" fill="#3A7EA0" opacity="0.92"/>
      <text x="262" y="203" textAnchor="middle" fontSize="13" fill="white" fontFamily="Georgia">&#945;</text>
      <line x1="255" y1="208" x2="252" y2="215" stroke="#3A7EA0" strokeWidth="2" strokeLinecap="round"/>
      <line x1="260" y1="209" x2="258" y2="216" stroke="#3A7EA0" strokeWidth="2" strokeLinecap="round"/>
      <line x1="265" y1="209" x2="264" y2="216" stroke="#3A7EA0" strokeWidth="2" strokeLinecap="round"/>
      <line x1="270" y1="208" x2="272" y2="215" stroke="#3A7EA0" strokeWidth="2" strokeLinecap="round"/>
      <polygon points="274,194 284,191 282,200" fill="#3A7EA0"/>
      <text x="295" y="188" fontSize="10" fill="#3A7EA0" fontStyle="italic" fontFamily="Georgia">crawls in!</text>
      <rect x="240" y="218" width="188" height="22" rx="3" fill="#4A4540"/>
      <rect x="246" y="212" width="60" height="28" rx="2" fill="#EFF6FB" stroke="#3A7EA0" strokeWidth="1.5"/>
      <text x="276" y="227" textAnchor="middle" fontSize="9.5" fill="#3A7EA0" fontFamily="Georgia">&#945; in &#8594;</text>
      <text x="333" y="256" textAnchor="middle" fontSize="9.5" fill="#7A7268" fontFamily="Georgia">Wall = IL-1 Receptor (door)</text>
      <text x="333" y="273" textAnchor="middle" fontSize="11" fill="#7C3AED" fontStyle="italic" fontFamily="Georgia">&#946; blocked &middot; &#945; crawls in &#10007;</text>

      {/* PANEL 3: RILO — α left, β right, both trapped */}
      <rect x="456" y="4" width="206" height="282" rx="9" fill="white" stroke="#059669" strokeWidth="2"/>
      <text x="559" y="29" textAnchor="middle" fontSize="14" fill="#059669" fontWeight="bold" fontFamily="Georgia">RILONACEPT</text>
      <text x="559" y="45" textAnchor="middle" fontSize="10.5" fill="#7A7268" fontFamily="Georgia">-cept = Decoy Receptor Trap</text>
      <circle cx="512" cy="82" r="21" fill="#3A7EA0"/>
      <text x="512" y="90" textAnchor="middle" fontSize="21" fill="white" fontFamily="Georgia">&#945;</text>
      <circle cx="606" cy="82" r="21" fill="#C8964A"/>
      <text x="606" y="90" textAnchor="middle" fontSize="21" fill="white" fontFamily="Georgia">&#946;</text>
      <line x1="512" y1="105" x2="522" y2="128" stroke="#3A7EA0" strokeWidth="1.5" strokeDasharray="3,2"/>
      <polygon points="517,127 527,124 525,134" fill="#3A7EA0"/>
      <line x1="606" y1="105" x2="596" y2="128" stroke="#C8964A" strokeWidth="1.5" strokeDasharray="3,2"/>
      <polygon points="591,124 601,127 599,137" fill="#C8964A"/>
      <polygon points="466,140 476,129 486,140 496,129 506,140 516,129 526,140 536,129 546,140 556,129 566,140 576,129 586,140 596,129 606,140 616,129 626,140 636,129 646,140 646,178 466,178" fill="#ECFDF5" stroke="#059669" strokeWidth="2"/>
      <circle cx="504" cy="160" r="14" fill="#3A7EA0" opacity="0.9"/>
      <text x="504" y="166" textAnchor="middle" fontSize="14" fill="white" fontFamily="Georgia">&#945;</text>
      <circle cx="614" cy="160" r="14" fill="#C8964A" opacity="0.9"/>
      <text x="614" y="166" textAnchor="middle" fontSize="14" fill="white" fontFamily="Georgia">&#946;</text>
      <text x="559" y="157" textAnchor="middle" fontSize="10" fill="#059669" fontWeight="bold" fontFamily="Georgia">DECOY DOOR</text>
      <text x="559" y="171" textAnchor="middle" fontSize="9" fill="#059669" fontFamily="Georgia">(-cept = trap)</text>
      <rect x="466" y="210" width="186" height="22" rx="3" fill="#4A4540" opacity="0.28"/>
      <rect x="524" y="205" width="70" height="27" rx="2" fill="#FAF8F5" stroke="#DDD6CB" strokeWidth="1"/>
      <text x="559" y="247" textAnchor="middle" fontSize="9.5" fill="#9CA3AF" fontFamily="Georgia">Real receptor &#8212; unreached</text>
      <text x="559" y="265" textAnchor="middle" fontSize="11" fill="#059669" fontStyle="italic" fontFamily="Georgia">&#945; + &#946;: both trapped &#10003;</text>
    </svg>
    <div style={{display:'flex',gap:'14px',justifyContent:'center',margin:'0 0 1.2rem',fontSize:'12px',color:'#4A4540',flexWrap:'wrap'}}>
      <span><span style={{display:'inline-block',width:'12px',height:'12px',background:'#3A7EA0',borderRadius:'50%',verticalAlign:'middle',marginRight:'4px'}}></span>&#945; = IL-1 alpha</span>
      <span><span style={{display:'inline-block',width:'12px',height:'12px',background:'#C8964A',borderRadius:'50%',verticalAlign:'middle',marginRight:'4px'}}></span>&#946; = IL-1 beta</span>
      <span><span style={{display:'inline-block',width:'28px',height:'5px',background:'#4A4540',borderRadius:'2px',verticalAlign:'middle',marginRight:'4px'}}></span>Wall = IL-1 Receptor</span>
    </div>
    <div className="mnemonic"><strong>&ldquo;ANA catches ALL at the wall. CANA lets alpha crawl in. RILO snaps the trap &mdash; -cept gets &lsquo;em all.&rdquo;</strong></div>
