    ...
    <>
      ...
      <div className="page-container">
        ...
        <div className="content-card" style={{ marginTop: '2rem' }}>
          ...
          <p>
            The GCA Fast Track Clinic is part of UW Medicine Rheumatology. For referrals and appointments:
          </p>
          <ul>
            <li>Referrals should indicate suspected GCA for expedited scheduling</li>
        ...
        <div className="content-card">
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <h3 style={{ color: 'var(--blue-accent)', fontSize: '1.1rem', marginBottom: '0.5rem' }}>
